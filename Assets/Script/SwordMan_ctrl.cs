...
public class SwordMan_ctrl : MonoBehaviour
{
    ...
    void Jump_Logic()
    {
        ...
        if (canJump && Input.GetKeyDown(KeyCode.C))
        {
            ...
            isJump = true;
            Sound_ctrl.PlaySound("sounds/char/Okita/sm_jump", false, false);
        }
    ...
    public void PlayAnimation(HeroAnimationState sta)
    {
        ...
        if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.站立)
            ...
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(181, 188, moveSpeed / 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.奔跑)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(106, 113, moveSpeed / 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.跳跃准备)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(126, 126, 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.跳跃起)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(127, 128, 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.跳跃顶)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(129, 129, 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.跳跃落)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(130, 131, 10, left);
        else if (heroAnimationState_Prev != heroAnimationState && sta == HeroAnimationState.跳跃底)
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(132, 132, 10, left);
            ...
            transform.GetChild(0).GetComponent<SpritePlayCtrl>().PlaySpriteAnimation(1, 10, AtkSpeed, left);
